...
# MAJOR_CLEARANCE outbound: resolve mavely/redirector links to clean merchant URLs before send.
MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_ENABLED: bool = True
MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS: int = 20
MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH: int = 10
MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS: int = 3
MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS: int = 900
...
def init(settings: Dict[str, Any]) -> None:
    ...
    global MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_ENABLED
    global MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS
    global MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH
    global MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS
    global MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS
    ...
    MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_ENABLED = bool(
        settings.get("major_clearance_resolve_affiliate_links_enabled", True)
    )
    MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS = _get_int(
        settings, "major_clearance_resolve_affiliate_links_timeout_seconds", 20
    )
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS < 5:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS = 5
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS > 60:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_TIMEOUT_SECONDS = 60
    MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH = _get_int(
        settings, "major_clearance_resolve_affiliate_links_max_depth", 10
    )
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH < 3:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH = 3
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH > 20:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_DEPTH = 20
    MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS = _get_int(
        settings, "major_clearance_resolve_affiliate_links_max_urls", 3
    )
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS < 1:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS = 1
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS > 6:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_MAX_URLS = 6
    MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS = _get_int(
        settings, "major_clearance_resolve_affiliate_links_cache_ttl_seconds", 900
    )
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS < 60:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS = 60
    if MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS > 24 * 60 * 60:
        MAJOR_CLEARANCE_RESOLVE_AFFILIATE_LINKS_CACHE_TTL_SECONDS = 24 * 60 * 60
